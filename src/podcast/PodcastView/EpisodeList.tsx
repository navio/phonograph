...
import { WarperComponent, WarperComponentRef } from "@itsmeadarsh/warper";
...
const EpisodeList = (props) => {
  ...
  const bottomChromeHeight = props.hasPlayer ? 112 : 56;
        ...
        {(state) => (
          <div
            style={{
              ...
              paddingBottom: `calc(${bottomChromeHeight}px + env(safe-area-inset-bottom))`,
            }}
          ...
          >
            ...
            {episodes && episodes.length > 0 ? (
              <WarperComponent
                ...
                estimateSize={() => 72}
                height={`calc(100vh - ${stickyOffset}px - ${bottomChromeHeight}px - env(safe-area-inset-bottom))`}
                overscan={5}
                loadingPlaceholder={
                ...
                errorPlaceholder={(error) => (
                  <div style={{ textAlign: "center", padding: "2rem", color: textColor }}>
                    Failed to initialize list: {error.message}
                  </div>
                )}
              >
                {(index) => {
