...
- `Unified CI` (`.github/workflows/quality-gates.yml`) runs web quality checks on every PR/push and automatically runs desktop checks when `src-tauri/tauri.conf.json` exists.
