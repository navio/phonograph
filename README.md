...
- `Unified CI` (`.github/workflows/quality-gates.yml`) runs web quality checks on every PR/push and adds desktop checks automatically when `src-tauri/tauri.conf.json` exists.
